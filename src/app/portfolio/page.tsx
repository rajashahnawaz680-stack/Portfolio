      ...
      <section className="py-20 container max-w-7xl mx-auto px-6">
        <div className="flex flex-col gap-16">
          {filteredCaseStudies.map((cs, idx) => (
            ...
            >
              {/* Screenshot Image Row on Top (Full Width) */}
              <div className="relative w-full h-64 md:h-[400px] lg:h-[450px] bg-brand-secondary/10 overflow-hidden border-b border-brand-border/60">
                <img
                  src={cs.image}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
                ...
                <div className="lg:col-span-8 p-8 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-brand-border/60">
                  ...
                  <div className="flex flex-wrap gap-1.5 mt-6 pt-4 border-t border-brand-border/40">
                ...
                <div className="lg:col-span-4 bg-brand-secondary/40 p-8 flex flex-col justify-center space-y-6">
                  ...
                  <div className="space-y-4">
                    {cs.results.map((res, rIdx) => (
                      <div key={rIdx} className="bg-brand-bg/50 border border-brand-border/60 rounded-xl p-3.5 flex flex-col">
